...
VALUES (random_uuid(), 'Bonjour', 'Hello', CURRENT_DATE, NULL, NULL, '54a964bd-9967-4adc-85d7-f00548492431', 1, CURRENT_DATE, CURRENT_DATE);
...
INSERT INTO flashcards (id, front, verse, created_date, front_image, back_image, deck_id, box_level, next_review_date, last_review_date)
VALUES (random_uuid(), 'Year of the Moon Landing', '1969', CURRENT_DATE, NULL, NULL, '54a964bd-9967-4adc-85d7-f00548492431', 1, CURRENT_DATE, CURRENT_DATE);
